...
# https://github.com/prettier/plugin-ruby#npm-package

# this is formated with pretier js plugin
# install
# cd /workspace/.ide/code-server/extensions/esbenp.prettier-vscode-9.5.0
# npm install --save-dev prettier @prettier/plugin-ruby
# or
# yarn add --dev prettier @prettier/plugin-ruby

# gem deps: gem install bundler prettier_print syntax_tree syntax_tree-haml syntax_tree-rbs
# NOTE: neeed to upgrade to node 14
#npm WARN EBADENGINE Unsupported engine {
#  npm WARN EBADENGINE   package: 'vsce@2.9.2',
#  npm WARN EBADENGINE   required: { node: '>= 14' },
#  npm WARN EBADENGINE   current: { node: 'v12.22.5', npm: '7.5.2' }
#  npm WARN EBADENGINE }
#  npm WARN EBADENGINE Unsupported engine {
#  npm WARN EBADENGINE   package: 'playwright@1.22.2',
#  npm WARN EBADENGINE   required: { node: '>=14' },
#  npm WARN EBADENGINE   current: { node: 'v12.22.5', npm: '7.5.2' }
#  npm WARN EBADENGINE }
#  npm WARN EBADENGINE Unsupported engine {
#  npm WARN EBADENGINE   package: 'playwright-core@1.22.2',
#  npm WARN EBADENGINE   required: { node: '>=14' },
#  npm WARN EBADENGINE   current: { node: 'v12.22.5', npm: '7.5.2' }
